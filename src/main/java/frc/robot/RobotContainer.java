...
public class RobotContainer {
 private final CommandXboxController m_driverController = 
  ...
  private final IntakePivot m_Pivot = new IntakePivot();
  private final MoveToPositionCommand m_moveToPositionCommand = new MoveToPositionCommand(m_Pivot);
  private final ManualPivotCommand m_ManualPivotCommand = new ManualPivotCommand(m_Pivot, () -> m_driverController.getRightY());
